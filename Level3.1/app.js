document.addEventListener('DOMContentLoaded', () => {
    ...
    function simulateGeneration(foodSpawnRate, nutritiveValue, survivalCost) {
        ...
        const maxFood = 800; // Capped for performance and visual clarity
        ...
        // 2. Individuals consume energy, check for eating, and split
        let births = 0;
        let deaths = 0;
        ...
        for (let i = 0; i < pop; i++) {
            ...
            // Check if organism eats any food dots
            // Organisms can consume food if it is within (radius + 6) pixels
            const eatRadius = org.radius + 6;
