...
class Deer:
    ...
    def reproduce(self, config):
        """
        Handles reproduction logic. If enough food has been eaten, deer has a chance to reproduce.
        :param config: Configuration object.
    ...
    def daily_update(self, config):
        ...
        self.age += 1
        # Deer dies if it starves too long or exceeds its maximum lifespan
